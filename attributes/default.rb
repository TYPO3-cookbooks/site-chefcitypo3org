...
default['jenkins_chefci']['jenkins_plugins'] = %w(
  ...
  blueocean-commons:1.1.2
  blueocean-config:1.1.2
  blueocean-dashboard:1.1.2
  blueocean-display-url:2.0
  blueocean-events:1.1.2
  blueocean-git-pipeline:1.1.2
  blueocean-github-pipeline:1.1.2
  blueocean-i18n:1.1.2
  blueocean-jwt:1.1.2
  blueocean-personalization:1.1.2
  blueocean-pipeline-api-impl:1.1.2
  blueocean-pipeline-editor:0.2.0
  blueocean-pipeline-scm-api:1.1.2
  blueocean-rest:1.1.2
  blueocean-rest-impl:1.1.2
  blueocean-web:1.1.2
  ...
  pipeline-model-api:1.1.7
  pipeline-model-declarative-agent:1.1.1
  pipeline-model-definition:1.1.7
  pipeline-model-extensions:1.1.7
  pipeline-rest-api:2.8
  pipeline-stage-step:2.2
  pipeline-stage-tags-metadata:1.1.7
